...
** Last update sam. juil. 05 15:26:33 2014 lefloc_l
*/
...
*/
void		send_position_to_graphic(t_kernel *, t_client *);
void		send_prend_to_graphic(t_kernel *, t_client *, int);
void		send_pose_to_graphic(t_kernel *, t_client *, int);
void		send_connexion_to_graphic(t_kernel *, t_client *);
void		send_egg_connexion_to_graphic(t_kernel *, t_client *, int);
