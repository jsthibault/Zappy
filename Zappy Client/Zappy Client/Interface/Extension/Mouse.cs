...
namespace Zappy_Client.Interface
{
    ...
    public static class MouseExt
    {
        ...
        private static Boolean firstMouseDown = false;
        private static MouseState CurrentMouseState { get; set; }
        private static MouseState LastMouseState { get; set; }

        public static Boolean FirstMouseDownState(this MouseState mouse)
        {
            return firstMouseDown;
        }
        ...
        public static void Update(this MouseState mouse)
        {
            ...
            if (CurrentMouseState.LeftButton == ButtonState.Pressed && mouseDown == false)
            {
                mouseDown = true;
                firstMouseDown = true;
            }
