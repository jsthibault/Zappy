...
namespace Zappy_Client
{
    public class Zappy : Game
    {
        ...
        /// <param name="e"></param>
        private void Zappy_Exiting(object sender, EventArgs e)
        {
            this.ExitGame();
        }
        ...
        {
            //AudioManager.Instance["main"] = this.Content.Load<Song>("Music//login.mp3");
            //AudioManager.Instance["game"] = this.Content.Load<Song>("Music//game.mp3");
