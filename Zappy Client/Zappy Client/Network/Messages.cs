...
namespace Zappy_Client
{
    public partial class Network
    {
        ...
        private Dictionary<String, CmdFunction> AnswerFunctions = new Dictionary<String, CmdFunction>()
        {
        ...
        private Dictionary<String, CmdFunction> AskFunctions = new Dictionary<String, CmdFunction>()
        {
