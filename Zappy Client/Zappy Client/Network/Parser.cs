...
namespace Zappy_Client
{
    static public class Parser
    {
        ...
        static Parser()
        {
            ...
            AuthorizedItems.Add(new Regex("^msz [\\d]* [\\d]*\\n$"));
            AuthorizedItems.Add(new Regex("^bct \\d* \\d* \\d* \\d* \\d* \\d* \\d* \\d*\\n$"));
            AuthorizedItems.Add(new Regex("^tna \\w*\\n$"));
            AuthorizedItems.Add(new Regex("^pnw #\\d* \\d* \\d* [N|O|S|E]:\\d \\d* \\w*\\n$"));
            AuthorizedItems.Add(new Regex("^ppo #\\d* \\d* \\d* [N|O|S|E]:\\d\\n$"));
            AuthorizedItems.Add(new Regex("^plv #\\d* \\d*\\n$"));
            AuthorizedItems.Add(new Regex("^pin #\\d* \\d* \\d* \\d* \\d* \\d* \\d* \\d* \\d* \\d*\\n$"));
            AuthorizedItems.Add(new Regex("^pex #\\d*\\n$"));
            AuthorizedItems.Add(new Regex("^pbc #\\d* .*\n$"));
            AuthorizedItems.Add(new Regex("^smg .*\n$"));
            AuthorizedItems.Add(new Regex("^pie \\d* \\d* [0|1]\\n$"));
            ...
            AuthorizedItems.Add(new Regex("^enw #\\d* #\\d* \\d* \\d*\\n$"));
